...
class AppURLS:
    BASE_URL = 'https://api.simple.app/api/v1/public/telegram/'
    PROFILE_URL = f'{BASE_URL}profile/'
    ACTIVATE_URL = f'{BASE_URL}activate/'
    TAP_URL = f'{BASE_URL}tap/'
    CLAIM_URL = f'{BASE_URL}claim/'
    GET_TASK_LIST_URL = f'{BASE_URL}get-task-list-2/'
    START_TASK_URL = f'{BASE_URL}start-task-start-2/'
    CHECK_TASK_URL = f'{BASE_URL}check-task-check-2/'
    FRIENDS_URL = f'{BASE_URL}friends/'
    CLAIM_FRIENDS_URL = f'{BASE_URL}claim_friends/'
    GET_SPIN_WHEEL_URL = f'{BASE_URL}get-spin-wheel/'
    CLAIM_SPIN_URL = f'{BASE_URL}claim-spin/'
